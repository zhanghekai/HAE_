...
checkpt_file = 'zhanghekai/DBLP/compairGATGAT/premodel/'
...
adj = np.load('zhanghekai/DBLP/compairGATGAT/small_adj_data.npy')
features = np.load('zhanghekai/DBLP/compairGATGAT/features.npy')

print('features.shape:', features.shape)
print('adj.shape:', adj.shape)

lastlabel = np.load('zhanghekai/DBLP/compairGATGAT/one_hot_labels.npy')
train_data = np.load('zhanghekai/DBLP/compairGATGAT/train_idx.npy')
test_data = np.load('zhanghekai/DBLP/compairGATGAT/test_idx.npy')
...
with tf.Graph().as_default():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(nb_epochs):
            ...
            with open('zhanghekai/DBLP/compairGATGAT/premodel/output.txt', 'a+') as fi:
            ...
            while ts_step * batch_size < ts_size:
                ...
                if (ts_acc / ts_step) > max_test_acc:
                    ...
                    print('...................Save Model................')
                    feas = np.array(feas)
                    np.save('zhanghekai/DBLP/compairGATGAT/premodel/featts.npy', feas)
