...
check_file = 'zhanghekai/DBLP/compairGCNGAT/premodel/'
...
alllabel = np.load('zhanghekai/DBLP/compairGCNGAT/one_hot_labels.npy')
train_data = np.load('zhanghekai/DBLP/compairGCNGAT/train_idx.npy')
test_data = np.load('zhanghekai/DBLP/compairGCNGAT/test_idx.npy')
...
if __name__ == "__main__":
    ...
    xdata = np.load("zhanghekai/DBLP/compairGCNGAT/features.npy")
    #xdata = preprocess_features_v1(xdata)
    adj_data = np.load("zhanghekai/DBLP/compairGCNGAT/small_adj_data.npy")
...
#                     print("batch loss: {:.4f}, batch acc: {:.4f}".format(loss, acc))
            ...
            with open('zhanghekai/DBLP/compairGCNGAT/premodel/output.txt', 'a+') as fi:
            ...
            if eva_acc > max_acc:
                ...
                np.save('zhanghekai/DBLP/compairGCNGAT/premodel//featts.npy', featts)
